...
public class Bill extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Select Date of Bill:");
...
// TODO add your handling code here:
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String billnu = jTextField1.getText();
        String date = jFormattedTextField1.getText();
        String sup = jTextField2.getText();
        String supco = jTextField3.getText();
        String fn = jTextField4.getText();
        String fc = jTextField5.getText();
        ...
        try {
            ...
            String sql = "insert into BILL(BILL_NUMBER,BILL_DATE,SUPPLIER,SUPPLIER_CODE,FOOD_NAME,FOOD_CODE,QUANTITY) values('"+ billnu +"','"+ date +"','"+ sup +"','"+ supco +"','"+ fn +"','"+ fc +"','"+ q +"')";
