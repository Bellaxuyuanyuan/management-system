...
public class AnimalUpdate extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Update Animal Data");

        jLabel2.setFont(new java.awt.Font("Cambria", 0, 14)); // NOI18N
        jLabel2.setText("Give Animal Code:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String coun = jTextField3.getText();
        ...
        try {
            ...
            if (confir == JOptionPane.YES_OPTION) {
                ...
                String sql = "update ANIMAL set ANIMAL_NAME='"+ na +"',COUNTRY='"+ coun +"',FOOD='"+ f +"',AGE='"+ age +"' where  ANIMAL_CODE = '"+ co +"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AnimalUpdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AnimalUpdate().setVisible(true);
            }
        });
    }
